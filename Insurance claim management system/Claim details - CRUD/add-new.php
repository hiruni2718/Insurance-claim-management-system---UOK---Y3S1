...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO submitted_claim (policy_id, policyholder_id, description, premium_amount, claim_amount, admit_date, discharge_date, death_date, death_reason, hospital_name, bank_name, branch, acc_no) 
VALUES ('$policy_id', '$policyholder_id', '$description', '$premium_amount', '$claim_amount', '$admit_date', '$discharge_date', '$death_date', '$death_reason', '$hospital_name', '$bank_name', '$branch', '$acc_no')";
